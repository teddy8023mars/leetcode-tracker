export const en = {
  ...
  today: {
    ...
    restartBody: 'The 10-minute plan is enough to rebuild momentum. Nothing is overdue.',
    currentPlan: 'Current plan',
    standardMode: 'Standard · 70 min',
    minimumMode: 'Minimum · 10 min',
    noBacklog: 'Missing a day never creates backlog.',
    startStandard: 'Start 70-minute session',
    startMinimum: 'Start 10-minute session',
