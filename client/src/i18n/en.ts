export const en = {
  ...
  settings: {
    ...
    llmMissing: 'Not configured. Daily judging uses the official examples bundled with the app and works offline; a model key is only needed for optional AI solutions and uncommon problems without usable local examples.',
  ...
  judge: {
    ...
    historyEmpty: 'No submissions yet \u2014 submitted solutions will appear here.',
    runtimeMs: 'Runtime',
    cases: 'Cases',
    case: 'Case',
    ...
    code: 'Code',
    firstGenerationHint: 'Judging uses bundled official examples whenever available, so daily practice normally needs no model key or internet connection.',
  },
